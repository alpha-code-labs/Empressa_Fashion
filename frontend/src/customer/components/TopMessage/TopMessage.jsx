...
=======
                <h1 className='font-text text-center text-3xl  text-black  mt-[60px] '>
                    <div className="flex justify-center items-center p-4 ">
                        <p className="p-2 px-4 font-heading"  >
...
<<<<<<< HEAD
=======
                <p className='font-text text-center text-xl  text-gray-800  mt-[30px] '>
